        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <form action="<?php echo base_url();?>index.php/payoff/update" method="post" enctype="multipart/form-data">
                            <?php
                            extract($po);
                            ?>
							<div class="header">
                           ...
                           <table border="0" cellpadding="10" cellspacing="0" width="500" align="center" class="table table-striped">
							...
							<tr>
							<td><label>Round Number Id</label></td>
							<td><input type="hidden" name="Id" class="txtField" value="<?php echo $id; ?>">
							<input type="text" name="roundNo" class="txtField" value="<?php echo $roundNo; ?>"></td>
							</tr>
							<tr>
							<td><label>Address</label></td>
							<td><input type="text" name="polose" class="txtField" value="<?php echo $polose; ?>"></td>
                            </tr>
                            <tr>
							<td><label>Individual Name</label></td>
							<td><input type="text" name="pogain" class="txtField" value="<?php echo $pogain; ?>"></td>
                            </tr>
                           	<tr>
