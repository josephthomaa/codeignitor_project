...
|
*/
$config['base_url'] = 'http://localhost:8079/codeig/';
...
define ( "OLD_CSS_PATH", $config ['base_url'] . "old-css/" );

define ( "IMAGE_PATH", $config ['base_url'] . "img/" );

define ( "JS_PATH", $config ['base_url'] . "js/" );

define ( "URI_LIBRARY", $config ['base_url'] . "library/" );

define ( "PLUGIN_PATH", $config ['base_url'] . "plugin/" );
